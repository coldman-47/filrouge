 ...
 */
final class Version20200818232627 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX promo_id ON brief_ma_promo (promo_id, brief_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX promo_id ON brief_ma_promo');
    }
}
