 ...
 */
final class Version20200831135553 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fil_discution CHANGE apprenant_livravle_partiel_id apprenant_livravle_partiel_id INT NOT NULL');
        $this->addSql('ALTER TABLE livrable_partiel ADD etat TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fil_discution CHANGE apprenant_livravle_partiel_id apprenant_livravle_partiel_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE livrable_partiel DROP etat');
    }
}
