 ...
 */
final class Version20200818183256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brief_ma_promo ADD id INT AUTO_INCREMENT NOT NULL, CHANGE brief_id brief_id INT DEFAULT NULL, CHANGE promo_id promo_id INT DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brief_ma_promo DROP id, CHANGE brief_id brief_id INT NOT NULL, CHANGE promo_id promo_id INT NOT NULL');
        $this->addSql('ALTER TABLE brief_ma_promo ADD PRIMARY KEY (brief_id, promo_id)');
    }
}
