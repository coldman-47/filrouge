 ...
 */
final class Version20200821152313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livrable_partiel DROP nombre_rendu, DROP nombre_corrige');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE livrable_partiel ADD nombre_rendu INT NOT NULL, ADD nombre_corrige INT NOT NULL');
    }
}
