 ...
 */
final class Version20200809160236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE groupe_promo (groupe_id INT NOT NULL, promo_id INT NOT NULL, INDEX IDX_E5BE54AB7A45358C (groupe_id), INDEX IDX_E5BE54ABD0C07AFF (promo_id), PRIMARY KEY(groupe_id, promo_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
