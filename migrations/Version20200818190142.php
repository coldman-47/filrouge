 ...
 */
final class Version20200818190142 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE brief_ma_promo ADD brief_id INT DEFAULT NULL, ADD promo_id INT DEFAULT NULL');
