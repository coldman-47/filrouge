 ...
 */
final class Version20200819131525 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE detail_brief_competence (id INT AUTO_INCREMENT NOT NULL, brief_id INT NOT NULL, competence_id INT NOT NULL, niveau_id INT NOT NULL, INDEX IDX_B4AF208715761DAB (competence_id), INDEX IDX_B4AF2087B3E9C81 (niveau_id), UNIQUE INDEX competence_brief_idx (competence_id, brief_id), INDEX IDX_B4AF2087757FABFF (brief_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
